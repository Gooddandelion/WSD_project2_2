...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-6">
            <img src="https://dummyimage.com/700x500/dee2e6/6c757d.jpg" class="d-block mx-lg-auto img-fluid rounded" alt="메인 이미지" width="700" height="500" loading="lazy">
        </div>
        <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3">나만의 JSP 게시판 프로젝트</h1>
            <p class="lead">
